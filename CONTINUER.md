...
| Stages | 8 Storm 2 stages (Hidden Leaf Forest, Forest of Quiet Movement, Forest of Death, Orochimaru's Hideout, Hidden Sand Gate, Five-Seal Barrier Cliff, Mount Myoboku, The Final Valley); the playable radius is derived from the floor mesh (up to 75 m) so the whole map is walkable; fighters follow the floor height |
